...
import 'package:cashless/models/abono.dart';
...
import 'package:cashless/models/ruta.dart';
import 'package:cashless/models/usuario.dart';
import 'package:cashless/models/usuario_venta.dart';
...
class Venta {
  ...
  factory Venta.fromJson(Map<String, dynamic> json) => Venta(
        ...
        liquidado: json['liquidado'] ?? false, plus: json['plus'],
      );
