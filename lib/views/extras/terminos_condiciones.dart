            ...
            children: [
              Text(
                ...
                style: GoogleFonts.quicksand(
                    fontSize: 25, color: Colors.white.withOpacity(.8)),
              ),
              const SizedBox(height: 15),
              Text(
                'Actualizado el 2023-03-21',
                style: GoogleFonts.quicksand(
                    fontSize: 17, color: Colors.white.withOpacity(.8)),
              ),
            ],
          ),
          elevation: 0,
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 20),
                Text(
                  '¿Cuándo usa Lakes Feel la información del usuario final de terceros?',
                  style: GoogleFonts.quicksand(
                      fontSize: 22, color: Colors.white.withOpacity(.8)),
                ),
                const SizedBox(height: 20),
                ...
                const SizedBox(height: 20),
                Text(
                  '¿Cuándo usa Lakes Feel la información del cliente de terceros?',
                  style: GoogleFonts.quicksand(
                      fontSize: 22, color: Colors.white.withOpacity(.8)),
                ),
                const SizedBox(height: 20),
                ...
                const SizedBox(height: 20),
                Text(
                  '¿La información recopilada a través del Servicio Lakes Feel es segura?',
                  style: GoogleFonts.quicksand(
                      fontSize: 22, color: Colors.white.withOpacity(.8)),
                ),
                const SizedBox(height: 20),
