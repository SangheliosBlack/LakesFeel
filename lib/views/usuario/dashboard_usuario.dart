              ...
              child: Column(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      final snackBar = SnackBar(
                        content: Text(
                          'No disponible hasta el 3/05/2023',
                          style: GoogleFonts.quicksand(color: Colors.white),
                        ),
                        ...
                        child: Column(
                            ...
                            children: [
                                ...
                                children: [
                                  ...
                                  Builder(builder: (context) {
                                    String formattedDate = DateFormat.yMMMEd(
                                        ...
                                        .add_jm()
                                        .format(
                                            authProvider.lastUpdate.toLocal());
                                    return Text(
                              ...
                              ListView.separated(
                                ...
                                itemBuilder: (context, index) => ConsumoWidget(
                                  venta: authProvider.listadoAcumulado[index],
                                ),
                                itemCount: authProvider.listadoAcumulado.length,
                  ...
                  GestureDetector(
                    onTap: () async {
                      if (!await launchUrl(
                          Uri.parse('https://www.instagram.com/juliosdfghjk/'),
